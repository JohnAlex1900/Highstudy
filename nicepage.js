  ...
  11946: function (t, e, n) {
    ...
    Object.defineProperty(i.prototype, "steps", {
      ...
      (i.prototype.getGlobalProgress = function (t) {
        var animation,
          e,
          n = ((this.animation.XL || {}).start || {}).at || "bottom",
          i = this.domTop,
          o;
      ...
      (i.prototype.apply = function () {
        if (this.state) {
          ...
          if (1 !== this.state.sx || 1 !== this.state.sy)
            transform.push(
              "scale(" +
                this.state.sx.toFixed(3) +
                ", " +
                this.state.sy.toFixed(3) +
                ")"
            );
          if (!transform.length) transform.push("rotate(0deg)");
          (this.dom.style.transform = transform.join(" ")),
            (this.dom.style.opacity =
              1 === this.state.op ? "" : this.state.op.toFixed(3)),
            (this.dom.style.filter = this.state.blur
              ? "blur(" + this.state.blur.toFixed(3) + "px)"
              : ""),
            this.dom.classList.toggle(
              "u-animation-sticky",
              Boolean(this.state.sticky)
            );
        }
      });
  },
